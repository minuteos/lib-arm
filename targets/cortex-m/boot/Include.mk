...
$(BOOT_OUTPUT).bin:
	$(MAKE) -f $(BASE_DIR)Base.mk INCLUDE_OVERRIDE_DIRS=$(SOURCE_DIR) PROJECT_SOURCE_DIR=$(BOOT_DIR) CONFIG=$(BOOT_CONFIG) OUTDIR=$(BOOT_OUTDIR) OBJDIR=$(BOOT_OBJDIR) NAME=bootloader LD_SCRIPT=boot.ld main binary
